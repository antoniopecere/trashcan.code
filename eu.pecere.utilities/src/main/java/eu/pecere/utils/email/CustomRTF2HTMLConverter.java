...
public class CustomRTF2HTMLConverter
{
	private static final Log log = LogFactory.getLog( CustomRTF2HTMLConverter.class );
	...
	private static String hexToString( String hex, String charset )
	{
		...
		try {
			...
			log.info( "Unsupported encoding: " + charset );
		}
		return null;
	}
